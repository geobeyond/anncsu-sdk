...
from anncsu._hooks import HookContext
from anncsu.types import OptionalNullable, UNSET
from anncsu.utils.unmarshal_json_response import unmarshal_json_response
...
class Status(BaseSDK):
    def show_status(
        ...
        *,
    ...
    ) -> models.ShowStatusResponse:
        r"""Ritorna lo stato dell'applicazione.
        ...
        if utils.match_response(http_res, "200", "application/problem+json"):
            return unmarshal_json_response(models.ShowStatusResponse, http_res)
